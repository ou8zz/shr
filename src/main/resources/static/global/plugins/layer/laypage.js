...
Page.prototype.view = function(){
    ...
    if(conf.total == 0){
        return '<div class="laypage_main laypageskin_molv"><label>&#x6CA1;&#x6709;&#x53EF;&#x663E;&#x793A;&#x7684;&#x6570;&#x636E;</label></div>';
    }
    
    if(conf.pages <= 1){
        return '<div class="laypage_main laypageskin_molv"><label>&#x5171;'+conf.total+'&#x6761;</label></div>';
    }
    ...
    return '<div name="laypage'+ laypage.v +'" class="laypage_main laypageskin_'+ (conf.skin ? (function(skin){
        ...
        + ' <button type="button" class="laypage_btn btn">\&#x786e;&#x5b9a</button></span>' 
        : '';
    }() +'</div>';
};
